...
function Hero({ onCTAClick }) {
  return (
    <section className="relative min-h-[88vh] w-full overflow-hidden bg-slate-950">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-end px-6 pt-24 pb-16 sm:pt-28 lg:pt-36">
        <motion.div
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-fuchsia-400/30 bg-slate-900/60 px-4 py-2 text-fuchsia-300 backdrop-blur-md">
            ...
            סוכנות דיגיטל עתידנית ל־SMB בישראל
          </div>
          <h1 className="mt-6 text-4xl font-black leading-tight tracking-tight text-white sm:text-5xl md:text-6xl">
            מגדילים הכנסות עם טכנולוגיה, קריאייטיב ומדידה בזמן אמת
          </h1>
          <p className="mt-4 text-lg leading-8 text-slate-300">
            צוות אחד שמחבר אסטרטגיה, קריאייטיב, מדיה ובינה מלאכותית – כדי להפוך תקציב פרסום להשקעה שמייצרת לקוחות אמיתיים.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-end gap-3">
            ...
            >
              <span className="relative z-10">דברו איתנו עכשיו</span>
            ...
            <a href="#cases" className="rounded-xl border border-slate-700/80 bg-slate-900/60 px-5 py-3 text-slate-200 backdrop-blur-md hover:border-slate-500/80">
              לראות תוצאות אמיתיות
            </a>
          </div>

          <div className="mt-8 flex flex-wrap items-center justify-end gap-6 text-slate-400">
            <div className="text-right">
              <div className="text-2xl font-extrabold text-white">+412%</div>
              <div className="text-xs">צמיחה ממוצעת בלידים בקמפיינים חדשים</div>
            </div>
            <div className="text-right">
              <div className="text-2xl font-extrabold text-white"><span className="align-middle">4.9★</span></div>
              <div className="text-xs">דירוג לקוחות ב־Google ו־Clutch</div>
            </div>
          </div>
        </motion.div>
      </div>
